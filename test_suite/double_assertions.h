...
int assert_equal_double(TestSuite* ts, char* test_name, double val1, double val2)
{
    if(val1 == val2)
...
int assert_not_equal_double(TestSuite* ts, char* test_name, double val1, double val2)
{
    if(val1 != val2)
        return TestSuite_pass(ts);
...
int assert_greater_than_double(TestSuite* ts, char* test_name, double val1, double val2)
{
    if(val1 > val2)
        return TestSuite_pass(ts);
